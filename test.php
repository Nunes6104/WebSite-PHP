...
<head>
    ...
    <link rel="icon" type="image/svg+xml" sizes="40x40" href="img/logo.png">
  ...
  <nav class="navbar navbar-dark bg-dark rounded shadow-lg">
    <div class="container-fluid">
      <a class="navbar-brand ms-4 d-inline fs-2" href="Main.html">
        <img src="img/logo.png" alt="Logo" style="max-width: 80px;" class="d-inline-block align-text-center ">
        Motion Bikes
      </a>
...
<footer> 
  <div class="hstack text-center">
    <div class="vstack fs-5"><strong>Motion Bikes</strong>
      ...
      <div class="p-2 fs-6">
        <a class="text-dark link-underline link-underline-opacity-0" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">
          Contacts
        </a>

        <div class="offcanvas offcanvas-buttom" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
          <div class="offcanvas-header">
          ...
          <div class="offcanvas-body">
            <div>
              ...
              <p>
                ...
                <h6>general@motionbikes.com
              </h6>
              <p></p>
              <p>
              </p><h5><b>Phone Number</b></h5>
              <h6>927402094</h6>
              <p></p>
            </div>
          </div>
  ...
  <div class="text-center">
    <hr>
    <small>© 2024 Cycling Motion Bikes. All rights reserved. The images shown may not correspond to the product
